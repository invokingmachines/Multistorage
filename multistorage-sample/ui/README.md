...
The dev server uses proxy config and forwards `/multistorage/**` to `http://localhost:8080`.

## Routes

- `/` — Home page with centered entity buttons
- `/browser/:activeEntity` — generic entity browser
- `/admin` — metadata admin page
